...
class InvoiceReportView(ExcelExport):
    ...
    def download_xls_ple_sale(self, **kw):
        ...
        columns = ['Nº Factura','Fecha Registro','Fecha Vencimiento','Moneda','Tipo Cambio','Condicion Pago','Nombre Cliente','Nº Ruc Cliente','Total Sin IGV','IGV','TOTAL CON IGV']
        rows = []
